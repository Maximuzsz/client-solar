...
interface GenerationChartWidgetProps {
  widget: WidgetConfig;
}

const GenerationChartWidget: React.FC<GenerationChartWidgetProps> = ({ widget }) => {
  ...
  // Consultar dados de geração da API
  const { data, isLoading, error } = useQuery({
    queryKey: ['/dashboard/generation', selectedTimeRange, unitId, networkId],
    queryFn: async () => {
      ...
      const response = await apiRequest('GET', `/dashboard/generation?${params.toString()}`);
...
export default GenerationChartWidget;